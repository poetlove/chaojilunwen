...
.controller('DashCtrl', function($rootScope, $scope, $http, $ionicPopover, $ionicSlideBoxDelegate, $ionicListDelegate, Topics, Tabs, News) {
...
.controller('ChatsCtrl', function($rootScope, $scope, $http,  $location) {
...
.controller('FilesCtrl', function($rootScope, $scope, $http, $stateParams) {
...
.controller('GroundCtrl', function($rootScope, $scope, $http, $ionicPopover, $ionicSlideBoxDelegate, $ionicListDelegate, Grounds, States, Grds) {
    ...
    $ionicPopover.fromTemplateUrl('templates/area-popover.html', {
      scope: $scope
    }).then(function(popover) {
      $scope.popover = popover;
    });
    ...
    $scope.changeTab = function(tab) {
      Grounds.setCurrentTab(tab);
      $scope.currentTab = Grounds.getCurrentTab();
      $scope.popover.hide();
    };  
	...
	//老师新闻读取
	$rootScope.topics = Grounds.getTopics();
	Grounds.fetchTopStories();
    ...
    $scope.loadMore = function() {
      // console.log("loadMore");
      Grounds.increaseNewTopicsCount();
      $scope.$broadcast('scroll.infiniteScrollComplete');
    };
    
	//list加载判断
    $scope.moreDataCanBeLoaded = function() {
      return Grounds.hasNextPage();
    };
...
.factory('Grounds', function($rootScope, $http) {
